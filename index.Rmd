...
<p style="font-family: times, serif; font-size:13pt">
   A recent graduate student with professional experience in _**Remote Sensing**_, _**GIS**_ and _**data analytics**_. Master both scripting environments (_**R,Python**_) and dedicated GIS/RS platforms (_**QGIS, ENVI, ERDAS IMAGINE, ArcGIS**_). Own skills with regards to large scale dataset (_**vector, raster, 3D point cloud data**_) analyzation. Always been a fast, motivated learner. Eager to explore and learn new things. Always seek challenges to improve herself. Aiming to use her knowledge as "power" to make the world a better place to live ;).<p/>
...
- GIS in context   
- Remote Sensing and GIS Integration (Python, Arcmap, R)
</p>

***Gained skills***    
      
<p style="font-family: times, serif; font-size:13pt">
- Become familiar with geocoding            
- Analyzing and managing LiDAR datasets     
- Interpretation of satellite imagery, image analysis, and photo interpretation   
- SQL                  
...
- Develop/optimize algorithm in R and Python           
- Object-detection from VHR imagery     
...
- Spatial & temporal statistics and modelling in R                  
- Handle large multidimensional arrays                
- Web-GIS/interactive visualization in Rshiny        
...
- Surveying and Mapping Case Analysis                
- Computer Cartography                       
- Photogrammetry                        
- GNSS Navigation and Poritioning                             
- Photogrammetry Field Practice                         
- Principles of Geographic Information System                       
- Urban Remote Sensing                   
- CAD Technology                      
- Remote Sensing Mapping               
- ENVI/IDL Remote Sensing Data Processing - 1 week                       
- Professional skills integrated practice - 4 weeks                     
- Digital Mapping Principles and Methods Practice - 4 weeks                       
- Surveying Practice - 2 weeks                   
- Practice for RS Image Processing - 1 week                        
- Practice of Professional Direction - 6 weeks                   
- Innovative Research and Design - 4 weeks                               
</p>
...
<p style="font-family:times;font-size:14pt;color:#586069">
**Experiences:**   
</p>
- Awarded scholarship for 3 times

- 02/2017-03/2017     Innovative Research and Design - 4 weeks      </p>                            
<p style="font-family: times, serif; font-size:12pt">
I participated in "Challenge Cup" National undergraduate Business Plan Competition. In this competition, our team won the silver award of Heilongjiang division.    
...
- 07/2016-08/2016     Professional skills integrated pratice - 4 weeks  </p>                            
<p style="font-family: times, serif; font-size:12pt">
...
<p style="font-family: times, serif; font-size:12pt; font-style:italic">
- 06/2016- 07/2016    Pratice of Professional Direction - 6 weeks   </p>                            
<p style="font-family: times, serif; font-size:12pt">
...
- Dutch -- A1-A2 (actively learning towards higher level)
