...
<p style="font-family: times, serif; font-size:13pt">
   A recent graduate student with professional experience in _**Remote Sensing**_, _**GIS**_ and _**data analytics**_. Master both scripting environments (_**R,Python**_) and dedicated GIS/RS platforms (_**QGIS, ENVI, ERDAS IMAGINE, Esri, GRASS GIS, SAGA GIS**_). Own skills with regards to large scale dataset (_**vector, raster, 3D point cloud data**_) analyzation. Always been a fast, motivated learner. Eager to explore and learn new things. Always seek challenges to improve herself. Aiming to use her knowledge as "power" to make the world a better place to live ;).<p/>
...
- Photogrammetry Field Pratice                         
- Principles of Geographic Information System                       
- Urban Remote Sensing                   
- CAD Technology                      
- Remote Sensing Mapping               
- ENVI/IDL Remote Sensing Data Processing - 1 week                       
- Professional skills integrated pratice - 4 weeks                     
- Digital Mapping Principles and Methods Pratice - 4 weeks                       
- Surveying Pratice - 2 weeks                   
- Practice for RS Image Processing - 1 week                        
- Pratice of Professional Direction - 6 weeks                   
